...
\begin{frame}
  ...
  \centering
  \footnotesize
  \href{https://github.com/SergioAlvesMar5/ProjectoFinal_MSW_TurismoSemantico}{\beamergotobutton{Repositorio GitHub}}
\end{frame}
...
\begin{frame}{Modelo semántico}
  \begin{columns}
    ...
    \begin{itemize}
      ...
      \item Propiedades: nombre, descripción, latitud, longitud, imagen, ID de Wikidata.
...
\begin{frame}{Demo en directo}
  ...
  \vspace{0.45cm}
  \href{http://127.0.0.1:5000}{\demolocalbutton}

  \vspace{0.55cm}
  \begin{block}{Flujo de demo}
    Mapa y filtros \(\rightarrow\) búsqueda semántica \(\rightarrow\) asistente IA \(\rightarrow\) grafo RDF \(\rightarrow\) SPARQL.
  \end{block}
